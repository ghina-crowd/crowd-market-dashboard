...
export class AppService {
    ...
    constructor(private translate: TranslateService) {
        ...
        if (localStorage.getItem('auth_token_crowd_admin')) {
            let authToken = localStorage.getItem('auth_token_crowd_admin') ? localStorage.getItem('auth_token_crowd_admin') : '';
            if(authToken){
        ...
        const token = localStorage.getItem('auth_token_crowd_admin');

...
export class AppComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.messagingService.currentMessage.subscribe(value => {
            if (value) {
                this.restService.notifyCount = this.restService.notifyCount + 1;
                this.restService.notificationCount.next(this.restService.notifyCount);
            }
        });
        if (this.appService.decoded) {
